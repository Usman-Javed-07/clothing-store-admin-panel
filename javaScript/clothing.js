    ...
    products.forEach((product) => {
      ...
      row.innerHTML = `
        ...
        product.name
                ...
                <td>
                    <button class="update-product btn btn-warning" data-id="${
                      product.id
                    }">Update</button>
                    <button class="delete-product btn btn-danger" data-id="${
                      product.id
                    }">Delete</button>
                </td>
            `;
    ...
    deleteButtons.forEach((button) => {
      button.addEventListener("click", (e) => {
        ...
        confirmDeleteButton.onclick = async () => {
          ...
          document.getElementById("successMessageContent").textContent =
        ...
        if (productToUpdate) {
          ...
          document.getElementById("updateProductForm").onsubmit = async (e) => {
            ...
            if (response.ok) {
              ...
              document.getElementById("errorMessageContent").textContent =
